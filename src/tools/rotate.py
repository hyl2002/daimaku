...
class CalibrateAngular():
    def __init__(self):
        ...
        self.test_angle = -radians(rospy.get_param('~test_angle', test))

        self.speed = rospy.get_param('~speed', 2.0) # radians per second
        #self.tolerance = radians(rospy.get_param('tolerance', 0.035)) # degrees converted to radians
        self.tolerance = rospy.get_param('tolerance', 0.025)
